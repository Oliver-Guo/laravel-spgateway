...
namespace Oliverkuo\Spgateway;

use Oliverkuo\Spgateway\Libraries\Helpers;
...
class Receipt
{
    ...
    public function search($orderNo, $amount)
    {
        ...
        $postDataEncrypted = [
            'MerchantID_' => config('spgateway.receipt.MerchantID'),
            'PostData_'   => $this->helpers->encryptPostData($postData, config('spgateway.receipt.HashKey'), config('spgateway.receipt.HashIV')),
        ];
